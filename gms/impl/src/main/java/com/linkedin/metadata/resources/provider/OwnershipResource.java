...
import com.linkedin.metadata.resources.dataset.BaseDatasetVersionedAspectResource;
...
/**
 * Rest.li entry point: /providers/{providerKey}/rawOwnership
 */
@Slf4j
@RestLiCollection(name = "rawOwnership", namespace = "com.linkedin.provider", parent = Providers.class)
